...
const rows = [
    createData('20230326FRU0001','Frutilla', formattedDateTime, 10, "En Camara", "LEROMA VALPARAÍSO"),
    createData('20230326DLB0001','Dulce de Leche Biscotti', formattedDateTime, 10, "En Camara", "LEROMA MANANTIALES"),
    createData('20230326DLB0002','Frutilla', formattedDateTime, 10, "En Camara", "LEROMA MANANTIALES"),
    createData('20230326CHB0001','Chocolate Blanco', formattedDateTime, 10, "En Camara", ""),
    createData('20230326CHB0002','Chocolate Blanco', formattedDateTime, 10, "En Camara", "LEROMA RECTA")
